      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 admissions-header">
          <h2 className="text-5xl md:text-6xl font-serif font-bold mb-6">
            <span className="text-school-navy-700">Begin Your </span>
            <span className="text-school-red-600">
              Wonder Journey
            </span>
          </h2>
          <p className="text-xl text-gray-700">
            Admissions are now open for 2026. Limited seats available.
          </p>
        </div>
        ...
        <div className="admissions-form bg-gray-50 rounded-2xl p-8 md:p-12 border-2 border-gray-200 shadow-elegant-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full group relative px-8 py-4 bg-school-red-600 text-white rounded-md font-bold text-lg hover:bg-school-red-700 transition-all duration-300 shadow-elegant hover:shadow-elegant-lg hover:-translate-y-0.5"
            >
